...
export const BRAND_SLUG_MAPPINGS = {
  'AS-IT-IS': 'as-it-is',
  'ON (OPTIMUM NUTRITION)': 'on-optimum-nutrition',
  'MI (MUSCLE IMPACT NUTRITION) 02 BRAND': 'mi-muscle-impact-nutrition-02-brand'
};

// Reverse mapping for converting slugs back to brand names
export const SLUG_TO_BRAND_MAPPINGS = {
  'as-it-is': 'AS-IT-IS',
  'on-optimum-nutrition': 'ON (OPTIMUM NUTRITION)',
  'mi-muscle-impact-nutrition-02-brand': 'MI (MUSCLE IMPACT NUTRITION) 02 BRAND',
  // Auto-generate mappings for all brands with parentheses
  'optimum-nutrition': 'ON (OPTIMUM NUTRITION)',
  'muscle-impact-nutrition-02-brand': 'MI (MUSCLE IMPACT NUTRITION) 02 BRAND'
};
